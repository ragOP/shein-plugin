...
// var campaignID = "6731eb55ff70b235e64ba263";
...
// }
// var initialSrc = "https://track.getsofferwin.com/" + campaignID + "?format=json";
...
//         if (el.href.indexOf("track.getsofferwin.com/click") > -1) {
...
//                 xhrr.open("GET", "https://track.getsofferwin.com/view?clickid=" + rawData.clickid)
//                 xhrr.send();
//             }
//         }
...
//         xhrTrack.open("GET", "https://track.getsofferwin.com/view?clickid=" + rtkClickID)
//         xhrTrack.send();
